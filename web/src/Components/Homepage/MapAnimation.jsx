      ...
      ([entry]) => {
        if (entry.isIntersecting && !hasAnimated) {
          const targetElements =
            mapRef.current.querySelectorAll(".animate-target");
  ...
  return (
    <div>
      <div className="global-impact-container">
        <h2 className="global-impact-title">Adoption</h2>
        <div className="global-impact-content">
          <p className="global-impact-description">
            The following countries are working with UNDP to adapt
            and scale the open-source carbon registry (using codebase or design
            patterns) to their national contexts.
          </p>
