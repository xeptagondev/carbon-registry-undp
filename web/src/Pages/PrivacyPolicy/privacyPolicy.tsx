  ...
  return (
    <div id="policy" className="privacy-container">
      ...
      <div className="privacy-body-container">
        <Row justify="center">
          <Col span={20}>
            ...
            <div className="privacy-body">
              ...
              <ul>
                <li>
                  Visit our website at https://carbreg.org, or any website of
        ...
        <Row justify="center">
          <Col span={20}>
            <div className="privacy-subtitle-summary">
            ...
            <div className="privacy-body">
              <p>
                <b>
                  ...
                  for. You can also click<a href="#toc"> here</a> to go directly
        ...
        <Row justify="center">
          <Col span={20}>
            ...
            <div className="privacy-body">
              ...
              <p>
                To exercise these rights, you can contact us Social Media
                Profiles, or by referring to the contact details at the bottom
